                ...
                <div class="login-content">
                    <form method="POST" class="login-form">
                        ...
                        <div class="input-group">
                            <label for="employer-id">
                                <i class="bi bi-person"></i> Employers Id
                            </label>
                            <input type="text" name="employer-id" id="employer-id" required>
                        </div>
                        <div class="pass-wrap"> 
...
<script>
    ...
    loginForm.addEventListener("submit", function(e){
        ...
        fetch("../../backend/admin/employers_details.php", {
            method: "POST",
            body: formData
        })
        .then(res => res.json())
